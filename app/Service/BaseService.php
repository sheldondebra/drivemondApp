...
class BaseService implements BaseServiceInterface
{
    ...
    {
        return $this->baseRepository->findOneBy(criteria: $criteria,whereInCriteria: $whereInCriteria, withAvgRelations: $withAvgRelations, relations: $relations, withCountQuery: $withCountQuery, withTrashed: $withTrashed, onlyTrashed: $onlyTrashed);
    }
