                        ...
                        <div class="card my-5 ov-hidden">
                            <div class="login-wrap">
                                ...
                                <div class="login-right-wrap">
                                    ...
                                    <div class="login-right px-0 pb-{{ env('APP_MODE') == 'demo' ? '3' : '5' }}">
                                        <div class="inner-div px-4">
                                            <div class="text-center mb-30">
                                                <img class="login-img login-logo mb-2"
                                                    ...
                                                    alt="">
                                                <h5 class="text-uppercase c1 mb-3">
                                                    {{ businessConfig('business_name')->value ?? null }}</h5>
                                    ...
                                    @if (env('APP_MODE') == 'demo')
                                        <div class="login-footer mt-auto d-flex justify-content-between bg-grey mt-3">
                                            <div>
