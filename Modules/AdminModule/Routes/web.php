...
use Modules\AdminModule\Http\Controllers\Web\Admin\SettingsController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], function () {
    Route::controller(\Modules\AdminModule\Http\Controllers\Web\New\Admin\DashboardController::class)->group(function () {
    ...
    Route::controller(\Modules\AdminModule\Http\Controllers\Web\New\Admin\ActivityLogController::class)->group(function () {
        Route::get('log', 'log')->name('log');
    });
    Route::controller(\Modules\AdminModule\Http\Controllers\Web\New\Admin\SettingController::class)->group(function () {
        Route::get('settings', 'index')->name('settings');
        Route::post('update-profile/{id}', 'update')->name('update-profile');
    });
    Route::controller(\Modules\AdminModule\Http\Controllers\Web\New\Admin\SharedController::class)->group(function () {
