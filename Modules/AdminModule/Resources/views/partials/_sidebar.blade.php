    ...
    <div class="position-relative flex-grow-1">
        <div class="aside-body" data-trigger="scrollbar">
            ...
            <ul class="main-nav nav">
                ...
                <li class="nav-category" title="{{ translate('trip_management')}}">{{ translate('trip_management')}}</li>
                    ...
                    <ul class="nav flex-column sub-menu text-capitalize">
                        ...
                        <li class="{{ Request::is('admin/trip/list/all') || (Request::is('admin/trip/details/*')  && Request::get('type') == 'all') ?'active open':'' }}">
                            <a href="{{route('admin.trip.index', ['all'])}}">
                                ...
                                <span class="link-title">{{ translate('all_trip')}}  </span> <span class="badge badge-primary float-end">{{$tripCount['all']}}</span>
                            </a>
                        </li>
                ...
                <li class="nav-category" title="{{ translate('user_management')}}">{{ translate('user_management')}}</li>
