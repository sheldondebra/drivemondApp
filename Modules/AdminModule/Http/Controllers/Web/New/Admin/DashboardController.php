...
class DashboardController extends BaseController
{
    ...
    {
        $trips = $this->tripRequestService->getBy(criteria: ['type' => 'ride_request'], relations: ['customer'], orderBy: ['created_at' => 'desc'], limit: 5, offset: 1);
    ...
    public function leaderBoardDriver(Request $request)
    {
        ...
        $leadDriver = $this->tripRequestService->getLeaderBoard($request->all());
    ...
    public function leaderBoardCustomer(Request $request)
    {
        ...
        $leadCustomer = $this->tripRequestService->getLeaderBoard($request->all());
