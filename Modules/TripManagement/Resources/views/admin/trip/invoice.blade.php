...
<body class="bg-white" id="printableTable">
    <div class="">
        ...
        <table class="table table-borderless table-striped text-dark">
            ...
            <tbody>
            <tr>
                <td class="p-3" style="background-color: #e0fffb">1</td>
                <td class="text-capitalize p-3" style="background-color: #e0fffb">{{translate('trip_cost')}}</td>
                <td class="text-end p-3" style="background-color: #e0fffb">{{set_currency_symbol($data->actual_fare)}}</td>
            </tr>
            <tr>
                <td class="p-3">2</td>
            ...
            @if($data->type != 'parcel')
                <tr>
                    <td class="p-3" style="vertical-align:top;background-color: #e0fffb">3</td>
            ...
            @endif
            <?php
            $totalAmount = $data->actual_fare + ($data?->fee?->delay_fee ?? 0) + ($data?->fee?->idle_fee ?? 0) + ($data?->fee?->cancellation_fee ?? 0) - ($data->coupon_amount ?? 0);
            ?>
            <tr>
                <td class="p-3" style="background-color: @if($data->type == 'parcel') #e0fffb @endif">{{ $data->type == 'parcel' ? 3:4 }}</td>
                <td class="p-3" style="background-color: @if($data->type == 'parcel') #e0fffb @endif">{{translate('VAT/Tax')}} <small class="font-semi-bold"><strong>({{ ((($data?->fee?->vat_tax ?? 0) * 100) / $totalAmount ?? 0) }}%)</strong></small></td>
                <td class="text-end p-3" style="background-color: @if($data->type == 'parcel') #e0fffb @endif">+ {{set_currency_symbol($data?->fee?->vat_tax + 0)}}</td>
            </tr>
            @if($data->tips>0)
                <tr>
                    <td class="p-3" style="background-color: @if($data->type != 'parcel') #e0fffb @endif">{{ $data->type == 'parcel' ? 4:7 }}</td>
