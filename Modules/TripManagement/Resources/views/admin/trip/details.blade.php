                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="px-xl-3">
                                            <dl class="data-list gy-2 text-dark">
                                                ...
                                                <?php
                                                    $totalAmount = $trip->actual_fare + ($trip?->fee?->delay_fee ?? 0) + ($trip?->fee?->idle_fee ?? 0) + ($trip?->fee?->cancellation_fee ?? 0) - ($trip->coupon_amount ?? 0);
                                                ?>

                                                <dt>
                                                    {{ translate('VAT/Tax') }}
                                                    <small class="font-semi-bold"><strong>({{ (($trip?->fee?->vat_tax ?? 0) * 100) / $totalAmount }}%)</strong></small>
                                                </dt>
