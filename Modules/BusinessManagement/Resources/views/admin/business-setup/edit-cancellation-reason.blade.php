<form
    ...
    <div class="modal-body">
        <div class="form-group mb-3 add_active_2 update-lang_form">
            <label for="updateTitle" class="form-label">{{translate('trip_cancellation_reason')}}</label>
            <input id="updateTitle" class="form-control" name="title" value="{{$cancellationReason->title}}"
                   type="text" required>
        </div>
        <div class="form-group mb-3 add_active_2 update-lang_form">
