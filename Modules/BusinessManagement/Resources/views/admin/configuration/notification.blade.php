                    ...
                    <form action="{{route('admin.business.configuration.notification.store')}}"
                        ...
                        <div class="form-group d-flex align-items-end gap-3">
                            <div class="flex-grow-1">
                                <label for="server_key" class="mb-2">{{translate('server_key')}} <span
                                        class="text-danger">*</span></label>
                                <input required type="text" name="server_key" id="server_key" class="form-control"
                                       placeholder="{{translate('Ex: #AB8376L09')}}"
                                       value="{{($settings?->value)}}">
                            </div>
                            <button class="btn btn-primary h-45" type="submit">{{translate('submit')}}</button>
                        </div>
                    </form>
                </div>
            </div>
