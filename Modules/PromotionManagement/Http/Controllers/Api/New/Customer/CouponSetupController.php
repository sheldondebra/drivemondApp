...
class CouponSetupController extends Controller
{
    ...
    public function __construct(CouponSetupServiceInterface $couponService, UserLevelServiceInterface $userLevelService, TripRequestServiceInterface $tripRequestService)
    {
