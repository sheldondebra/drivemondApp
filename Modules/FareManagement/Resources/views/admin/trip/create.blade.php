                        ...
                        <div class="row gy-4 custom-class-fare mt-3">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    <input type="number" class="form-control part-1-input copy-value" step=".01" name="base_fare" id="base_fare"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    <input type="number" name="min_cancellation_fee" step=".01"
                                           class="form-control part-1-input copy-value"
        ...
        inputCustomElements.forEach(input => {
            input.addEventListener('input', function () {
                if (parseFloat(this.value) < 0) {
                    this.value = 1;
                    toastr.error('{{translate('negative_value_is_not_allow')}}')
