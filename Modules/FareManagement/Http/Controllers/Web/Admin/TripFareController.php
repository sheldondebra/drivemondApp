...
class TripFareController extends Controller
{
    ...
    public function store(Request $request): Renderable|RedirectResponse
    {
        $request->validate([
            ...
            'waiting_fee' => 'nullable|gt:0',
            'cancellation_fee' => 'nullable|gt:0',
            'min_cancellation_fee' => 'nullable|gt:0',
            'idle_fee' => 'nullable|gt:0',
            'trip_delay_fee' => 'nullable|gt:0',
            'penalty_fee_for_cancel' => 'nullable|gt:0',
            'fee_add_to_next' => 'nullable|gt:0',
        ]);
