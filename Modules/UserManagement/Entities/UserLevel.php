...
class UserLevel extends Model
{
    ...
    protected $casts = [
        ...
        'targeted_ride'=>'integer',
        'targeted_ride_point'=>'integer',
        'targeted_amount'=>'double',
        'targeted_amount_point'=>'integer',
        'targeted_cancel'=>'integer',
        'targeted_cancel_point'=>'integer',
        'targeted_review'=>'integer',
        'targeted_review_point'=>'integer',
        'is_active'=> 'integer'
    ];
