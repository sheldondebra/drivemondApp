...
class DriverService extends BaseService implements Interface\DriverServiceInterface
{
    ...
    public function show(int|string $id, array $data)
    {
        ...
        if ($tab == 'overview') {
            ...
            $driverTrips = $this->tripRequestRepository->getBy(criteria: $criteria, searchCriteria: $searchCriteria, relations: ['customer', 'driver', 'fee'], limit: paginationLimit(), offset: $data['page'] ?? 1);
            $otherData = [
                'trips' => $driverTrips,
