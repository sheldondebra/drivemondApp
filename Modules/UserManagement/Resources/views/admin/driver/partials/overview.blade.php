                            ...
                            <ul class="list-unstyled d-flex flex-column gap-3 text-dark mb-0">
                                ...
                                <li>
                                    <div class="d-flex gap-3 justify-content-between">
                                        ...
                                        <span
                                            class="badge badge-primary fs-14">{{getSession('currency_symbol')}} {{$otherData['driver_lowest_fare']}}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="d-flex gap-3 justify-content-between">
                                        ...
                                        <span
                                            class="badge badge-primary fs-14">{{getSession('currency_symbol')}} {{$otherData['driver_highest_fare']}}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
