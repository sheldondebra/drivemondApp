                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" disabled class="form-control"
                                                value="{{ $level->sequence }}" placeholder="{{ translate('ex') }}: {{ translate('2') }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_ride" value="{{ $level->targeted_ride }}"
                                        id="min_ride_complete" class="form-control" placeholder="{{ translate('ex') }}: {{ translate('50') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_ride_point"
                                        ...
                                        placeholder="{{ translate('ex') }}: {{ translate('500') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" step=".01" name="targeted_amount"
                                        ...
                                        placeholder="{{ translate('ex') }}: {{ translate('5000') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_amount_point"
                                        ...
                                        placeholder="{{ translate('ex') }}: {{ translate('900') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_cancel" value="{{ $level->targeted_cancel }}"
                                        id="max_cancellation_rate" class="form-control" placeholder="{{ translate('ex') }}: {{ translate('50') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_cancel_point"
                                        ...
                                        placeholder="{{ translate('ex') }}: {{ translate('300') }}" required>
                                </div>
                            </div>
