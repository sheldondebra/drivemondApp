                                    ...
                                    <div class="table-top d-flex flex-wrap gap-10 justify-content-between">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul
                                                    class="dropdown-menu dropdown-menu-lg dropdown-menu-right text-capitalize @if ($customers->count() < 3)
                                                    mx-h-190-scroll
                                                    @endif">
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="text-capitalize">{{ translate('customer_name') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" type="checkbox"
                                                                    checked="checked" name="customer-name">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="text-capitalize">{{ translate('profile_status') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" type="checkbox"
                                                                    checked="checked" name="profile-status">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="text-capitalize">{{ translate('contact_info') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" type="checkbox"
                                                                    checked="checked" name="contact-info">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="text-capitalize">{{ translate('total_trip') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" type="checkbox"
                                                                    checked="checked" name="total-trip">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    </li>
