                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select class="js-select" name="sequence" id="select_level_number" required>
                                                ...
                                                @foreach ($sequences as $sequence)
                                                    <option value="{{ $sequence }}">{{ translate($sequence) }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            ...
                                            <select class="js-select" name="reward_type" id="rewardType" required>
                                                <option value="" selected disabled>
                                                    {{ translate('select_reward_type') }}</option>
                                                <option value="no_rewards">{{ translate('no_rewards') }}</option>
                                                <option value="wallet">{{ translate('wallet') }}</option>
                                                <option value="loyalty_points">{{ translate('loyalty_points') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 d-none" id="rewardAmountDiv">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" step=".01" name="reward_amount"
                                                value="{{ old('reward_amount') }}" id="rewardAmount" class="form-control"
                                                placeholder="Ex: 500">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_review" value="{{ old('targeted_review') }}"
