        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.customer.level.update', ['id' => $level->id]) }}" method="post"
                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" disabled name="" class="form-control"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="name" value="{{ $level->name }}" id="l_name"
                                                class="form-control" placeholder="Ex: Platinum" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-4">
                                        ...
                                        <div class="upload-file">
                                            ...
                                            <div class="upload-file__img w-auto h-auto">
                                                <img src="{{ onErrorImage(
                                                    ...
                                                    class="custom-box-size" alt="" style="--size: 150px">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_ride" value="{{ $level->targeted_ride }}"
                                        id="min_ride_complete" class="form-control" placeholder="Ex: 50" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    <label for="min_earn_amount"
                                        class="mb-2">{{ translate('minimum_spend_amount') }}</label>
                                    <input type="number" name="targeted_amount" value="{{ $level->targeted_amount }}"
                                        id="min_earn_amount" step=".01" class="form-control" placeholder="Ex: 5000"
                                        required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="targeted_cancel" value="{{ $level->targeted_cancel }}"
                                        id="max_cancellation_rate" class="form-control" placeholder="Ex: 50" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-4">
                                    <label for="min_give_review"
                                        class="mb-2">{{ translate('minimum_review_given') }}</label>
                                    <input type="number" name="targeted_review" value="{{ $level->targeted_review }}"
                                        id="min_give_review" class="form-control" placeholder="Ex: 100" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mb-4">
                ...
                <div class="d-flex justify-content-end gap-3 mt-3">
                    <button class="btn btn-secondary" type="reset">{{ translate('discard') }}</button>
