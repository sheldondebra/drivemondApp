                                    ...
                                    <div class="table-top d-flex flex-wrap gap-10 justify-content-between">
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul
                                                    class="dropdown-menu dropdown-menu-lg dropdown-menu-right text-capitalize @if ($levels->count() < 3)
                                                    mx-h-190-scroll
                                                    @endif">
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            ...
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" name="sl"
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="text-capitalize">{{ translate('level_name') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" name="level_name"
                                                                    type="checkbox" checked="checked">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="text-capitalize">{{ translate('total_ride_complete') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column"
                                                                    name="total_ride_complete" type="checkbox"
                                                                    checked="checked">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="text-capitalize">{{ translate('maximum_cancellation_rate') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column"
                                                                    name="maximum_cancellation_rate" type="checkbox"
                                                                    checked="checked">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="total_customer">{{ translate('total_customer') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column"
                                                                    name="total_customer" type="checkbox"
                                                                    checked="checked">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="total_customer">{{ translate('status') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" name="status"
                                                                    type="checkbox" checked="checked">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <li class="dropdown-item py-2">
                                                        <div
                                                            class="d-flex align-items-center gap-4 justify-content-between">
                                                            <span
                                                                class="total_customer">{{ translate('action') }}</span>
                                                            <label class="switcher">
                                                                <input class="switcher_input table-column" name="action"
                                                                    type="checkbox" checked="checked">
                                                                <span class="switcher_control"></span>
                                                            </label>
                                                        </div>
                                            ...
                                            <thead class="table-light align-middle text-capitalize">
                                                <tr>
                                                    ...
                                                    <th class="minimum_earning_amount text-start">
                                                        {{ translate('minimum') }}
                                                        <br>{{ translate('spend_amount') }} - {{ translate('point') }}
                                                    </th>

                                                    <th class="trip_cancellation_rate text-start">
                                                        {{ translate('ride_cancellation_rate') }}
                                                        <br> - {{ translate('point') }}
                                                    </th>
