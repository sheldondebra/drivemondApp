...
class CustomerController extends BaseController
{
    ...
    public function trash(Request $request)
    {
        ...
        $customers = $this->customerService->trashedData(relations: ['level', 'lastLocations.zone', 'customerTrips', 'customerTripsStatus'], limit: paginationLimit(), offset:$request['page']??1,orderBy : ['created_at' => 'desc']);
